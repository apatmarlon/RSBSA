...
<head>
    ...
    <title>Registry System for Basic Sectors in Agriculture</title>
    <!-- plugins:css -->
...
<div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="{{ URL::to('/admin_dashboard') }}"><img src="images/aniatkita.png" alt="Logo"></a>
        </div>
        ...
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="user-info">
                    ...
                    <div class="details">
                        <p class="user-name">RSBSA ENROLLMENT SYSTEM</p>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ URL::to('/allstudent') }}">
                            ...
                            <span class="menu-title">All Client</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="layoutsSubmenu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ URL::to('/report') }}">GroupBy Address</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="pages/layout/rtl-layout.html">Individual</a>
                                </li>
...
<script type = 'text/javascript' src="{{asset('https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js')}}"></script>
</body>
<script>
...
<script>
                                    $(document).ready(function(){
                                                                    $("select[name='student_civilstatus']").on('change',function(){
                                                                    if($(this).val()=='Married'){
                                                                        $("input[name='student_spouse']").prop("disabled",false);
                                                                    }else{
                                                                        $("input[name='student_spouse']").prop("disabled",true);
                                                                    }
                                                                    });
                                                                });
</script>
